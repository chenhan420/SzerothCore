...
_module void AddSC_DuelReset(bool reload)
{ 
    new DuelResetWorld();
    new DuelResetScript();
...
_module void FreeSC_DuelReset() 
{ 
    ScriptRegistry<WorldScript>::FreeScript("DuelResetWorld"); 
    ScriptRegistry<PlayerScript>::FreeScript("DuelResetScript"); 
}